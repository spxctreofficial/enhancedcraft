...
public class TrollTntEntity extends Entity {
	...
	public final int fuseTime = rand.nextInt(20 * 5) + 1;

	public TrollTntEntity(EntityType<? extends TrollTntEntity> entityType, World world) {
	...
	protected void initDataTracker() {
		this.dataTracker.startTracking(FUSE, fuseTime);
	}
	...
	private void explode() {
		float f = 3.0F;
		this.world.createExplosion(this, this.getX(), this.getBodyY(0.0625D), this.getZ(), f, Explosion.DestructionType.NONE);
	}
