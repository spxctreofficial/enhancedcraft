...
public class TridentMolds {
	...
	public static class TridentMoldDamaged extends Item {
		public TridentMoldDamaged() {
			super(new Settings().group(ItemGroup.MISC).maxCount(1).recipeRemainder(ECRegistry.SHATTERED_TRIDENT_MOLD));
		}
	...
	public static class TridentMold extends Item {
		public TridentMold() {
			super(new Settings().group(ItemGroup.MISC).maxCount(1).recipeRemainder(ECRegistry.DAMAGED_TRIDENT_MOLD));
		}
